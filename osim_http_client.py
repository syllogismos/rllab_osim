...
class Client(object):
    ...
    def env_create(self):
        ...
        self.observation_space = Box(np.array(obi['low']), np.array(obi['high']))
    ...
    def reset(self):
        return self.env_reset(self.instance_id)

    def step(self, action, render=False):
        o, r, d, i = self.env_step(self.instance_id, list(action), render)
        o = np.array(o)
        return o, r, d, i
